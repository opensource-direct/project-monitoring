            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group input-group">
                        ...
                        <textarea type="text" class="form-control" id="reminder_detail" name="reminder_detail" style="height: 200px">{{ isset($reminder) ? $reminder->reminder_detail : '' }}</textarea>
                    </div>
                    ...
                    <div class="form-group input-group">
                        ...
                        <input type="text" class="form-control" id="project_name" name="project_name" value="{{ isset($reminder) ? $reminder->project_name : '' }}">
                    </div>
